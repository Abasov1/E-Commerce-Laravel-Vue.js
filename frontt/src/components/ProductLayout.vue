...
<template>
    <header id="header" class="u-header u-header-left-aligned-nav">
         <div class="u-header__section">
                                                ...
                                                <div id="searchClassic" class="dropdown-menu dropdown-unfold dropdown-menu-right left-0 mx-2" aria-labelledby="searchClassicInvoker">
                                                    <form class="js-focus-state input-group px-3">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button class="btn btn-primary px-3" type="button"><i class="font-size-18 bi bi-search"></i></button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <!-- End Input -->
             ...
             <div v-if="this.$route.name === 'Home' && categories" class="d-none d-xl-block container">
                    <div class="row">
                        <!-- Vertical Menu -->
                                    ...
                                    <div class="card border-0">
                                        <div class="card-header card-collapse border-0" id="basicsHeadingOne">
                                            <button type="button" class="btn-link btn-remove-focus btn-block d-flex card-btn py-3 text-lh-1 px-4 shadow-none btn-primary rounded-top-lg border-0 font-weight-bold text-gray-90"
                                                ...
                                                <span class="pl-1 text-gray-90">All Departmentsss</span>
                                            </button>
                                        </div>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="mb-4">
                            <div class="row no-gutters">
                                <div class="col-auto">
                                    <i class="bi bi-headset text-primary font-size-56"></i>
                                </div>
                                <div class="col pl-3">
                    ...
                    <div class="col-lg-7">
                        <div class="row">
                            <div class="col-12 col-md mb-4 mb-md-0">
                                <h6 class="mb-3 font-weight-bold">{{store.state.user.language.categories}}</h6>
                                <!-- List Group -->
                                <ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                    <li v-if="categories" v-for="cat in categories" :key="cat.id"><router-link class="list-group-item list-group-item-action" :to="{name:'Category',params:{slug:cat.slug}}">{{cat.name}}</router-link></li>
                                </ul>
                                <!-- End List Group -->
                            </div>
                            <div class="col-12 col-md mb-4 mb-md-0">
                                ...
                                <!-- List Group -->
                                <ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                    <li><router-link class="list-group-item list-group-item-action" :to="{name:'WishList'}">{{store.state.user.language.wishlist}}</router-link></li>
                                    <li><router-link class="list-group-item list-group-item-action" :to="{name:'Cart'}">{{store.state.user.language.cart}}</router-link></li>
                                </ul>
                                <!-- End List Group -->
                            </div>
                        </div>
